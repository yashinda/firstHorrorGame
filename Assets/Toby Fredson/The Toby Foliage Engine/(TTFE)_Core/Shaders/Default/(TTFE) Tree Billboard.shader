	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float Ao_Output141_g1337 = pow( abs( AoMapBase31_g1337 ) , _AmbientOcclusionIntensity );
				
				float2 uv_AlbedoMap80_g1337 = packedInput.ase_texcoord5.xy;
				float Opacity_Output86_g1337 = tex2D( _AlbedoMap, uv_AlbedoMap80_g1337 ).a;
